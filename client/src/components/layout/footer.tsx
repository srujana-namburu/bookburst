    ...
    <footer className="bg-primary text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-xl font-serif font-bold mb-4">BookBurst</h3>
            <p className="text-primary-foreground/80 text-sm">
              Your reading journey, reimagined. Track, discover, and connect with a community of book lovers.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/80">
              ...
              <li>
                <Link href="/story">
                  <a className="hover:text-white transition">Our Story</a>
                </Link>
              </li>
              <li>
                <Link href="/team">
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/80">
              ...
              <li>
                <Link href="/accessibility">
                  <a className="hover:text-white transition">Accessibility</a>
                </Link>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-2 text-sm text-primary-foreground/80">
              ...
              <li>
                <Link href="/guidelines">
                  <a className="hover:text-white transition">Content Guidelines</a>
                </Link>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-primary-foreground/20 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-primary-foreground/70">© {new Date().getFullYear()} BookBurst. All rights reserved.</p>
