...
export function BookCard({
  ...
  return (
    <div className="book-card bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden flex flex-col">
        ...
        <div className="flex justify-between items-center">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem onClick={() => onUpdateStatus?.(id, "reading")}>
                Mark as Reading
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => onUpdateStatus?.(id, "finished")}>
                Mark as Finished
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => onUpdateStatus?.(id, "want_to_read")}>
                Add to Want to Read
              </DropdownMenuItem>
